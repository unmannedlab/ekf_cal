...
<!-- The increasing complexity of autonomous systems operating in challenging environments demands robust and accurate calibration methods. This paper introduces the `ekf_cal` package, a comprehensive framework for testing multi-sensor Kalman filters using Monte Carlo techniques. -->
