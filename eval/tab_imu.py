...
def plot_acc_measurements(imu_dfs):
    ...
    for imu_df in imu_dfs:
        ...
        fig.line(t_imu, imu_df['acc_0'].to_list(), alpha=a, color=colors[0], legend_label='x')
        fig.line(t_imu, imu_df['acc_1'].to_list(), alpha=a, color=colors[1], legend_label='y')
        fig.line(t_imu, imu_df['acc_2'].to_list(), alpha=a, color=colors[2], legend_label='z')
    return fig
...
def plot_omg_measurements(imu_dfs):
    ...
    for imu_df in imu_dfs:
        t_imu = imu_df['time'].to_list()
        fig.line(t_imu, imu_df['omg_0'].to_list(), alpha=a, color=colors[0], legend_label='x')
        fig.line(t_imu, imu_df['omg_1'].to_list(), alpha=a, color=colors[1], legend_label='y')
        fig.line(t_imu, imu_df['omg_2'].to_list(), alpha=a, color=colors[2], legend_label='z')
    return fig
...
def plot_acc_residuals(imu_dfs):
    ...
    for imu_df in imu_dfs:
        t_imu = imu_df['time'].to_list()
        fig.line(t_imu, imu_df['residual_0'].to_list(), alpha=a, color=colors[0], legend_label='x')
        fig.line(t_imu, imu_df['residual_1'].to_list(), alpha=a, color=colors[1], legend_label='y')
        fig.line(t_imu, imu_df['residual_2'].to_list(), alpha=a, color=colors[2], legend_label='z')
    return fig
...
def plot_omg_residuals(imu_dfs):
    ...
    for imu_df in imu_dfs:
        t_imu = imu_df['time'].to_list()
        fig.line(t_imu, imu_df['residual_3'].to_list(), alpha=a, color=colors[0], legend_label='x')
        fig.line(t_imu, imu_df['residual_4'].to_list(), alpha=a, color=colors[1], legend_label='y')
        fig.line(t_imu, imu_df['residual_5'].to_list(), alpha=a, color=colors[2], legend_label='z')
    return fig
