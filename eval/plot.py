...
class Plotter():
    ...
    def plot_camera_body_pos_updates(self, cam_dfs):
        ...
        for cam_df in cam_dfs:
            ...
            axs_1.plot(time, cam_df['body_update_0'].to_list(), 'o-', alpha=a, color='tab:blue')
            axs_1.plot(time, cam_df['body_update_1'].to_list(), 'o-', alpha=a, color='tab:orange')
            axs_1.plot(time, cam_df['body_update_2'].to_list(), 'o-', alpha=a, color='tab:green')
            axs_2.plot(time, cam_df['body_update_3'].to_list(), 'o-', alpha=a, color='tab:blue')
            axs_2.plot(time, cam_df['body_update_4'].to_list(), 'o-', alpha=a, color='tab:orange')
            axs_2.plot(time, cam_df['body_update_5'].to_list(), 'o-', alpha=a, color='tab:green')
            axs_3.plot(time, cam_df['body_update_6'].to_list(), 'o-', alpha=a, color='tab:blue')
            axs_3.plot(time, cam_df['body_update_7'].to_list(), 'o-', alpha=a, color='tab:orange')
            axs_3.plot(time, cam_df['body_update_8'].to_list(), 'o-', alpha=a, color='tab:green')
    ...
    def plot_camera_body_ang_updates(self, cam_dfs):
        ...
        for cam_df in cam_dfs:
            time = cam_df['time'].to_list()
            axs_1.plot(time, cam_df['body_update_9'].to_list(), 'o-', alpha=a, color='tab:blue')
            axs_1.plot(time, cam_df['body_update_10'].to_list(), 'o-', alpha=a, color='tab:orange')
            axs_1.plot(time, cam_df['body_update_11'].to_list(), 'o-', alpha=a, color='tab:green')
            axs_2.plot(time, cam_df['body_update_12'].to_list(), 'o-', alpha=a, color='tab:blue')
            axs_2.plot(time, cam_df['body_update_13'].to_list(), 'o-', alpha=a, color='tab:orange')
            axs_2.plot(time, cam_df['body_update_14'].to_list(), 'o-', alpha=a, color='tab:green')
            axs_3.plot(time, cam_df['body_update_15'].to_list(), 'o-', alpha=a, color='tab:blue')
            axs_3.plot(time, cam_df['body_update_16'].to_list(), 'o-', alpha=a, color='tab:orange')
            axs_3.plot(time, cam_df['body_update_17'].to_list(), 'o-', alpha=a, color='tab:green')
