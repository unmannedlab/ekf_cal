...
TEST(test_Imu, GetMeasurementJacobian) {
  ...
  CustomAssertions::EXPECT_EIGEN_NEAR(jacOut1, jacExp1, 1e-6);
  ...
  CustomAssertions::EXPECT_EIGEN_NEAR(jacOut2, jacExp2, 1e-6);
  ...
  CustomAssertions::EXPECT_EIGEN_NEAR(jacOut3, jacExp3, 1e-6);
  ...
  CustomAssertions::EXPECT_EIGEN_NEAR(jacOut4, jacExp4, 1e-6);
}
